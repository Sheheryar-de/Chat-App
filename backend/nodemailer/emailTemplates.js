...
export const WELCOME_EMAIL = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
<tr class=""><td class="headline">Welcome Aboard!</td></tr>
<tr>
<td>
...
<td class="" style="color:#444; font-weight: 400;"><br><br>
 A property management application that helps you manage your real estate portfolio with ease and efficiency. <br><br>
  You have successfully been registered as a new <br/><em>User</em><br>
 <br>
  Your name and email are provided below:
<br>
<span style="font-weight:bold;">Email: &nbsp;</span><span style="font-weight:lighter;" class="">{email}</span> 
 <br>
  <span style="font-weight:bold;">Name: &nbsp;</span><span style="font-weight:lighter;" class="">{name}</span>
<br><br>  
<br></td>
</tr>
</tbody></table></center>
